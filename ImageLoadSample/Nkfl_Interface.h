...
//
//		Copyright(c) 1999-2023, Nikon Corporation - All rights reserved.
/*********************************************************/
...
//
	...
	typedef unsigned long WINAPI NkflGetDataProc( unsigned long ulDone, unsigned long ulTotal, const void* pData, unsigned long ulRowBytes, RECT* rect, void* pClientData );
	typedef NkflGetDataProc* NkflGetDataProcPtr;
	...
	typedef unsigned long NkflGetDataProc( unsigned long ulDone, unsigned long ulTotal, const void* pData, unsigned long ulRowBytes, RECT* rect, void* pClientData );
	typedef NkflGetDataProc* NkflGetDataProcPtr;
...
typedef struct tagNkflImageParam
{
	...
	NkflGetDataProc* pGetDataFunc;			//	Pointer to a callback function for receiving image data
	void*			pClientData;			//	Client's private data for pGetDataFunc
} NkflImageParam, *NkflImagePtr;

///////////////////////////////////////////////////////////
//	NkflSaveParam
//		It's for kNkfl_Cmd_Save
//
typedef struct tagNkflSaveParam
{
	unsigned long	ulSize;					//	Size of structure
	unsigned long	ulSessionID;			//	ID value of session
	long			lSaveMode;				//	eNkflSaveMode
	char			filename[256];			//	UTF8 file name
	long			lFileType;				//	eNkflSaveFileType
	char			appname[256];			//	Application name
	long			lJpegQuality;			//	eNkflJpegQuality
	long			lTiffOption;			//	eNkflTiffOption
	long			lHeifOption;			//	eNkflHeifOption
	long			lHeifDynamicRange;		//	eNkflHeifDynamicRange
} NkflSaveParam, *NkflSavePtr;
...
enum eNkflCommand
{
	...
	kNkfl_Cmd_Save	// 1.41.0 and after
};
...
{
	kNkfl_RawDevelopment_RawParameterSet	= 0x0001,
	kNkfl_RawDevelopment_RawQuality			= 0x0002,
	kNkfl_RawDevelopment_ExpComp			= 0x0004,
	kNkfl_RawDevelopment_WBAdjustment		= 0x0008,
	kNkfl_RawDevelopment_Tint				= 0x0010,
	kNkfl_RawDevelopment_NR					= 0x0020,
	kNkfl_RawDevelopment_PictureControl		= 0x0040,
	kNkfl_RawDevelopment_ColorMode			= 0x0080,
	kNkfl_RawDevelopment_Sharpness			= 0x0100,
	kNkfl_RawDevelopment_ToneComp			= 0x0200,
	kNkfl_RawDevelopment_Saturation			= 0x0400,
	kNkfl_RawDevelopment_HueAdjustment		= 0x0800,
	kNkfl_RawDevelopment_FilterEffect		= 0x1000,
	kNkfl_RawDevelopment_ActiveDLighting	= 0x2000,
	kNkfl_RawDevelopment_SkinSoftening		= 0x4000,
	kNkfl_RawDevelopment_PortraitImpressionBalance			= 0x8000
};
...
enum eNkflSaveMode
{
	kNkfl_SaveMode_SaveSidecarData			= 0,
	kNkfl_SaveMode_RemoveSidecarData,
	kNkfl_SaveMode_SaveFile
};

///////////////////////////////////////////////////////////
// eNkflSaveFileType
enum eNkflSaveFileType
{
	kNkfl_SaveFileType_Jpeg = 3,
	kNkfl_SaveFileType_Tiff = 2,
	kNkfl_SaveFileType_Heif = 6
};

///////////////////////////////////////////////////////////
// eNkflJpegQuality
enum eNkflJpegQuality
{
	kNkfl_JpegQuality_Default  = -1,
	kNkfl_JpegQuality_Smallest = 10,
	kNkfl_JpegQuality_Small    = 30,
	kNkfl_JpegQuality_Normal   = 60,
	kNkfl_JpegQuality_Good     = 80,
	kNkfl_JpegQuality_Best     = 100
};

///////////////////////////////////////////////////////////
// eNkflTiffOption
enum eNkflTiffOption
{
	kNkfl_TiffOption_None      = -1,
	kNkfl_TiffOption_RGB8      = 0,
	kNkfl_TiffOption_RGB8_LZW  = 1,
	kNkfl_TiffOption_RGB16     = 2,
	kNkfl_TiffOption_RGB16_LZW = 3,
	kNkfl_TiffOption_CMYK      = 4
};

///////////////////////////////////////////////////////////
// eNkflHeifOption
enum eNkflHeifOption
{
	kNkfl_HeifOption_None      = -1,
	kNkfl_HeifOption_8bit      = 0,
	kNkfl_HeifOption_10bit     = 1
};

///////////////////////////////////////////////////////////
// eNkflHeifDynamicRange
enum eNkflHeifDynamicRange
{
	kNkfl_HeifDynamicRange_None   = -1,
	kNkfl_HeifDynamicRange_HLG    = 0,
	kNkfl_HeifDynamicRange_PQ     = 1
};
...
enum eNkflPictureControlVersion
{
	...
	kNkfl_PictureControlVersion_Latest	= kNkfl_PictureControlVersion_0300, // Latest( = ver.3).
};
